...
// raw.json
// --output
// tmp/simple_template_weights/pallet_sudo.rs
...
impl<T: frame_system::Config> pallet_sudo::WeightInfo for SubstrateWeight<T> {
	...
	fn set_key() -> Weight {
		...
		Weight::from_parts(12_371_000, 1517)
	...
	fn sudo() -> Weight {
		...
		Weight::from_parts(13_823_000, 1517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:0)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
	fn sudo_as() -> Weight {
		...
		Weight::from_parts(13_913_000, 1517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
	}
	/// Storage: `Sudo::Key` (r:1 w:1)
	/// Proof: `Sudo::Key` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
	fn remove_key() -> Weight {
		...
		Weight::from_parts(10_841_000, 1517)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}