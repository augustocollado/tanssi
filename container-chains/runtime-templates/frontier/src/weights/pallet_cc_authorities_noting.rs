...
// raw.json
// --output
// tmp/frontier_template_weights/pallet_cc_authorities_noting.rs
...
impl<T: frame_system::Config> pallet_cc_authorities_noting::WeightInfo for SubstrateWeight<T> {
	...
	fn set_latest_authorities_data() -> Weight {
		...
		//  Measured:  `141`
		//  Estimated: `1626`
		// Minimum execution time: 27_869_000 picoseconds.
		Weight::from_parts(28_360_000, 1626)
	...
	fn set_authorities(x: u32, ) -> Weight {
		...
		Weight::from_parts(7_556_746, 0)
			// Standard Error: 2_217
			.saturating_add(Weight::from_parts(51_042, 0).saturating_mul(x.into()))
