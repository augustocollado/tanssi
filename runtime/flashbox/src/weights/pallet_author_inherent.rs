...
// raw.json
// --output
// tmp/flashbox_weights/pallet_author_inherent.rs
...
impl<T: frame_system::Config> pallet_author_inherent::WeightInfo for SubstrateWeight<T> {
	...
	/// Storage: `AuthorityAssignment::CollatorContainerChain` (r:1 w:0)
	/// Proof: `AuthorityAssignment::CollatorContainerChain` (`max_values`: None, `max_size`: None, mode: `Measured`)
	...
	fn kick_off_authorship_validation() -> Weight {
		...
		Weight::from_parts(18_805_000, 3999)
