...
// raw.json
// --output
// tmp/flashbox_weights/pallet_collator_assignment.rs
...
impl<T: frame_system::Config> pallet_collator_assignment::WeightInfo for SubstrateWeight<T> {
	...
	fn new_session(x: u32, y: u32, ) -> Weight {
		...
		Weight::from_parts(47_667_532, 4687)
			// Standard Error: 8_902
			.saturating_add(Weight::from_parts(296_815, 0).saturating_mul(x.into()))
			// Standard Error: 90_641
			.saturating_add(Weight::from_parts(16_724_313, 0).saturating_mul(y.into()))
